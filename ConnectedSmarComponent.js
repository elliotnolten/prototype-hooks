...
export function useConnectedSmartComponent(
    ...
    const [connectedContainer, connectedComponent] = useMemo<
        [React.ReactElement | null, React.ReactElement | null]
    >(() => {
        const listItemAsArray = Children.toArray(listItem)
        ...
        const containerChildren = Children.toArray(container.props.children)
